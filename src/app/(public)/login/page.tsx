  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-6 py-16 bg-surface">
      <div className="w-full max-w-md bg-background shadow-[0_1px_3px_rgba(0,0,0,0.06)] border border-border/60 px-8 sm:px-10 py-10 text-center">
        <h1 className="text-3xl font-black tracking-tight mb-2">Lifting Social</h1>
        <p className="text-sm text-muted mb-8">Sign in to your account</p>

        {error && (
          <div className="mb-5 text-sm text-foreground border border-foreground/40 bg-foreground/5 px-3 py-2 text-left">
        ...
        <form action={googleSignIn}>
          <button
            type="submit"
            className="w-full inline-flex items-center justify-center gap-2.5 border border-border bg-background hover:bg-surface transition-colors py-3 px-4 text-sm font-medium text-foreground"
          >
            <GoogleLogo />
            Sign in with Google
          </button>
